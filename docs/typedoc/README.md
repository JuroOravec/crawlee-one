...
[See all features](_media/features.md)
...
| ------------------------------------------------------------------------- | --------------------------------------------------------------- |
| **[Import URLs](_media/playbook-01-import-urls.md)**                      | Load URLs from databases, datasets, or custom functions.        |
| **[Data transforms](_media/playbook-03-results-mapping-simple.md)**       | Rename, select, limit, and reshape output without code changes. |
| **[Request filtering](_media/playbook-06-requests-mapping-filtering.md)** | Control what gets scraped to save time and money.               |
| **[Caching](_media/playbook-07-caching.md)**                              | Incremental scraping -- only process new entries.               |
| **[Privacy compliance](_media/playbook-10-privacy-compliance.md)**        | Redact personal data with a single toggle.                      |
| **[Error capture](_media/playbook-11-errors.md)**                         | Centralized error tracking across scrapers.                     |

[See all 12 use cases](_media/use-cases.md)
...
1. Read the [getting started guide](_media/getting-started.md) for a full walkthrough of `crawleeOne()` and its options.
2. See [example projects](#example-projects) for real-world usage.
3. Managing multiple crawlers in one project? Use [codegen](_media/codegen.md) to generate typed helper functions from a config file.
...
[User guide](_media/user-guide.md)

![Apify actor input page](_media/user-guide-input-ui-open.png)

## Documentation

| Document                                                        | Description                                                 |
| --------------------------------------------------------------- | ----------------------------------------------------------- |
| [Getting started](_media/getting-started.md)                    | Developer guide with full `crawleeOne()` options reference. |
| [Features](_media/features.md)                                  | Complete feature catalog with code examples.                |
| [Use cases](_media/use-cases.md)                                | All 12 use cases with links to detailed guides.             |
| [Input reference](_media/reference-input.md)                    | All available input fields.                                 |
| [Deploying to Apify](_media/deploying-to-apify.md)              | Step-by-step Apify deployment guide.                        |
| [Codegen](_media/codegen.md)                                    | Generate typed crawler definitions from config.             |
| [Integrations](_media/integrations.md)                          | Custom telemetry and storage backends.                      |
| [User guide](_media/user-guide.md)                              | Guide for end users of CrawleeOne scrapers.                 |
| [API reference](_media/globals.md)                      | Auto-generated TypeScript API docs.                         |
| [Crawlee & Apify overview](_media/scraping-workflow-summary.md) | Background on how Crawlee and Apify work.                   |
...
When contributing code, please fork the repo and submit a pull request. See [CONTRIBUTING.md](_media/CONTRIBUTING.md) for dev setup and guidelines.

## Development

Want to build, test, or hack on CrawleeOne? The [development guide](_media/README.md) covers prerequisites, all npm scripts, project structure, architecture, and testing strategy.
