...
Defined in: [packages/crawlee-one/src/cli/commands/config.ts:51](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/cli/commands/config.ts#L51)
