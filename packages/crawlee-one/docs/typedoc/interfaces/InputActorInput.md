...
Defined in: [packages/crawlee-one/src/lib/input.ts:47](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/input.ts#L47)
...
Defined in: [packages/crawlee-one/src/lib/input.ts:58](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/input.ts#L58)
