...
Defined in: [packages/crawlee-one/src/lib/actor/types.ts:395](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/actor/types.ts#L395)
