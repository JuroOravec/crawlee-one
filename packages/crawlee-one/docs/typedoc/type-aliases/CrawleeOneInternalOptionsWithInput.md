...
Defined in: [packages/crawlee-one/src/lib/context/types.ts:308](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/context/types.ts#L308)
