...
Defined in: [packages/crawlee-one/src/lib/actor/types.ts:141](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/actor/types.ts#L141)
