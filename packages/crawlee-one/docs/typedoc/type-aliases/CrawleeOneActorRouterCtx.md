...
Defined in: [packages/crawlee-one/src/lib/actor/types.ts:75](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/actor/types.ts#L75)
...
Defined in: [packages/crawlee-one/src/lib/actor/types.ts:76](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/actor/types.ts#L76)
...
Defined in: [packages/crawlee-one/src/lib/actor/types.ts:78](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/actor/types.ts#L78)
...
Defined in: [packages/crawlee-one/src/lib/actor/types.ts:87](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/actor/types.ts#L87)
...
Defined in: [packages/crawlee-one/src/lib/actor/types.ts:97](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/actor/types.ts#L97)
