...
[crawlee-one](../README.md) / CrawlerConfigActorInput
...
Defined in: [packages/crawlee-one/src/lib/input.ts:30](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/input.ts#L30)
