...
[crawlee-one](../README.md) / CrawleeOneRouteCtx
...
Defined in: [packages/crawlee-one/src/lib/router/types.ts:8](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/router/types.ts#L8)
