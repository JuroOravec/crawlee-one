...
[crawlee-one](../README.md) / outputInputValidationFields

# Variable: outputInputValidationFields

> `const` **outputInputValidationFields**: `object`

Defined in: [packages/crawlee-one/src/lib/input.ts:1113](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/input.ts#L1113)
