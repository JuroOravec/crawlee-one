...
[crawlee-one](../README.md) / crawlerInputValidationFields

# Variable: crawlerInputValidationFields

> `const` **crawlerInputValidationFields**: `object`

Defined in: [packages/crawlee-one/src/lib/input.ts:1054](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/input.ts#L1054)
