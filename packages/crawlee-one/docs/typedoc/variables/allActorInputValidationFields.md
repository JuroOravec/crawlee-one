...
[crawlee-one](../README.md) / allActorInputValidationFields

# Variable: allActorInputValidationFields

> `const` **allActorInputValidationFields**: `object`

Defined in: [packages/crawlee-one/src/lib/input.ts:1140](https://github.com/JuroOravec/crawlee-one/blob/main/packages/crawlee-one/src/lib/input.ts#L1140)
...
> **maxCrawlDepth**: `NumberSchema`\<`number`\>
...
> **startUrlsFromFunction**: (`StringSchema`\<`string`\> \| `FunctionSchema`\<`Function`\>)[]
