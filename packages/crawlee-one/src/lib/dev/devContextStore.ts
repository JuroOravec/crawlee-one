 ...
 * the dev RequestQueue from context.routes and patch the crawler, so scrapers
...
export interface DevContext {
  ...
  /** Runs before user's onReady in dev mode. Has access to context.routes. */
  devOnReady?: (context: { routes: Record<string, any>; crawler: any }) => Promise<void>;
