...
> **createActorConfig**\<`T`\>(`config`): `T`

Defined in: [config.ts:136](https://github.com/JuroOravec/crawlee-one/blob/main/packages/apify-actor-config/src/types/config.ts#L136)
